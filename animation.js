...
function moveB()
{
    imageSlider.style.transform = 'translate(-1070px)';
    nowIndex =2;
}

function moveC()
{
    imageSlider.style.transform = 'translate(-2140px)';
    nowIndex =3;
}

function moveD()
{
    imageSlider.style.transform = 'translate(-3210px)';
    nowIndex =4;
}

function moveE()
{
    imageSlider.style.transform = 'translate(-4280px)';
    nowIndex =5;
}
